...
public class UI_Base : MonoBehaviour
{
    ...
    public static void BindEvent(GameObject go, Action<PointerEventData> action, UI_Define.UIEvent type = UI_Define.UIEvent.Click)
    {
        ...
        switch (type)
        {
            ...
            case UI_Define.UIEvent.Drag:
                ...
                evt.OnDragHandler += action;
                break;
            case UI_Define.UIEvent.DragEnd:
    ...
    public static void BindEvent(GameObject go, Action<PointerEventData, object> action, object pivot, UI_Define.UIEvent type = UI_Define.UIEvent.Click)
    {
